            ...
            <div id="payment-info-header" className="row">
                  ...
                  <form>
                    ...
                    <div className="credit-card-details">
                      <div className="credit-card-number">
                        <input type="number" name="card-number" placeholder="Credit card number" autoComplete="cc-number" required/>
                      </div>
              ...
              <div id="customer-navigation" className="row">
                ...
                <div className="six columns">
                  <Link to='/success'><button onClick={this.props.onSubmitOrder}>Complete Order</button></Link>
                </div>
              </div>
